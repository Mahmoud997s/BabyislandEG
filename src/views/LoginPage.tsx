                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <motion.div variants={itemVariants} className="space-y-2">
                                    ...
                                    <div className="text-left mt-2">
                                        <LocaleLink href="/forgot-password" className="text-sm text-[#0EA5E9] hover:text-[#F97316] transition-colors font-medium">
                            ...
                            <motion.div variants={itemVariants} className="mt-8 text-center text-base">
                                ...
                                <LocaleLink href="/register" className="text-[#0EA5E9] font-bold hover:text-[#F97316] transition-colors">
