...
export default function ContactPage() {
    ...
    const handleFallback = () => {
        const subject = encodeURIComponent(`${process.env.NEXT_PUBLIC_CONTACT_SUBJECT_PREFIX || "[BabyislandEG]"} ${formData.subject || "New Message"}`);
        const body = encodeURIComponent(`Name: ${formData.name}\nPhone: ${formData.phone}\nEmail: ${formData.email}\n\nMessage:\n${formData.message}`);
        const mailtoLink = `mailto:${process.env.NEXT_PUBLIC_CONTACT_TO_EMAIL || "info@strollerchic.com"}?subject=${subject}&body=${body}`;
            ...
            try {
                await emailjs.send(
                    ...
                    templateId,
                    {
                        ...
                        to_email: process.env.NEXT_PUBLIC_CONTACT_TO_EMAIL
                    },
                    publicKey
                );
                toast({
